...
async def on_message(scp):
    ...
    if scp.content.startswith('!환영'): 
        ...
        embed.add_field(name="일단,", value=f"member 권한이 없으신 분들께서 껐다 키면 로그가 안 보이는 불편을 겪으실 수 있습니다. <#563173658231701507>, <#556145244832530433>외의 다른 방에 못 들어가는 불편 역시 겪으실 수 있습니다. (#숯례문에 들어가시면 자세히 보실 수 있습니다).", inline=True)
