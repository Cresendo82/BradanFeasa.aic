...
async def on_member_join(member):
    for channel in member.guild.channels:
        if channel.name == '남태령':
            ...
            embed.add_field(name="주의하셔야 할점이 있는데,", value="만약 가입 절차 내용을 누설 시 __***즉시 밴 처리 될 수 있습니다.***__ 또한 __***비회원은 경고시 즉시 밴***__임을 알아두길 바라겠습니다. 더 많은 규칙을 위해 http://ko.scp-wiki.net/chat-guide 이걸 읽어주세요.", inline=True)
