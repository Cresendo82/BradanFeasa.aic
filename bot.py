...
async def on_guild_join(member):
    embed=discord.Embed(title="환영합니다!", description="SCP 세계관 공식 한국어 사이트 대화방에 오신걸 환영합니다!", color=0x00ff56)
    ...
    await client.get_channel(556145244832530433).send(f"환영해요 <@{str(member.id)}>님")
